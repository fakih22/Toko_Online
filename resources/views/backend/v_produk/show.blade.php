                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{ asset('storage/img-produk/' . $show->foto) }}" class="foto-preview img-fluid" style="width: 100%; max-width: 400px;">
                            </div>
                            ...
                            <div id="foto-container">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <img src="{{ asset('storage/img-produk/' . $gambar->foto) }}" class="img-fluid mb-2" style="width: 100%; max-width: 300px;">
                                    </div>
                                    <div class="col-md-4">
